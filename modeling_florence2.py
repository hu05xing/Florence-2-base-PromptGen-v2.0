...
class Florence2LanguageForConditionalGeneration(PreTrainedModel, GenerationMixin):
    base_model_prefix = "model"
...
class Florence2VisionModelWithProjection(Florence2PreTrainedModel):
    ...
    def forward(self, pixel_values):
        ...
        for i, t in enumerate(new_x):
            print(f"new_x[{i}] shape:", t.shape)
        print("image_projection shape:", self.image_projection.shape)
